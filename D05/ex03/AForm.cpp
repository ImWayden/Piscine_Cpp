...
/*   Updated: 2025/02/13 17:14:20 by wayden           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(const AForm& from) : name(from.getName()), isSigned(from.getIsSigned()), gradeToSign(from.getGradeToSign()), gradeToExec(from.getGradeToExec()){
	isGradeValid();
}
